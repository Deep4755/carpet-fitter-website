    ...
    <section className="py-24 bg-[var(--color-warm-white)]">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          />
          {/* Glow */}
          <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full bg-[var(--color-gold)]/8 blur-[100px] pointer-events-none" />
          <div className="absolute -bottom-32 -left-32 w-80 h-80 rounded-full bg-[var(--color-gold)]/6 blur-[80px] pointer-events-none" />

          <div className="relative grid lg:grid-cols-2 gap-12 items-center px-10 py-16 md:px-16 md:py-20">
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl lg:text-[2.75rem] font-bold text-white leading-tight">
                Get Professional Carpet Fitting &amp; Flooring Installation
              </h2>
              <p className="mt-5 text-[15px] text-slate-300 leading-relaxed max-w-lg">
                Professional carpet fitting and flooring installation services across London and surrounding areas. Free measuring service, no-obligation quote within 24 hours.
              </p>
            ...
            <div className="flex flex-col gap-4 lg:items-end">
              ...
              <p className="text-xs text-slate-500 text-center lg:text-right">Mon–Sat 8am–6pm · Free measuring service included</p>
            </div>
          </div>
        </motion.div>
      </div>
